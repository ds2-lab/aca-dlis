		 ...
		 bool allow_duplicates = true>
			 class Apex : public Tree<T, P> {
				 ...
				 forceinline bool lock_parent_node(
					 ...
					 void get_stats() {
						 std::cout<<"========stats======\n";
						 std::cout<<size() + ","<<stats_.num_data_nodes<<","<<stats_.num_model_nodes;
						 std::cout<<"\n===================\n";

					 }
					 void get_depth_info() {
						 std::cout<<"stats_.num_keys="<<stats_.num_keys<<"\n";
					 }
					 ...
					 void split_sideways_downwards_without_parent(
                         ...
                         //std::cout<<"split_sideways_downwards_without_parent()\n";
...
RETRAVEL:
                        ...
                        std::cout<<"resize_parent_check: parent->num_children_=" << parent->num_children_
                                   <<"; depth="<<traversal_path.size()
                                   <<"\n";
